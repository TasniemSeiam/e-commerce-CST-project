...
function getCategories(getProduct) {
  ...
  return categoriesarr;
    ...
    function displayProduct(product, _location) {
        ...
        if (product.rating.count == 0) { productDiv.appendChild(productCount); }
...
function sillingProduct() {
    ...
    silingProductFromend(numOfLength, (numOfLength - 5), getProduct, carouselItemnewArrival1);

    let carouselItemnewArrival2 = document.querySelectorAll(".divOFnewArrival .divOFbestsellengnewArrival .carousel-item .row")[1];
    silingProductFromend((numOfLength - 5), (numOfLength - 10), getProduct, carouselItemnewArrival2);
...
async function filteredProductsByCategory(products, _textcontent, _locAppendto) {
